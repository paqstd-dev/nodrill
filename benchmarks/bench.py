...
The first rows are one function doing one read, reached four ways, so the
...
from nodrill import FromCtx, inject, injected, provider, use, wrap
...
# The published order: the four comparable reads, then the floor, then the scope costs.
ORDER = (PASSED, USED, INJECTED, FROZEN, ALONE, REFERENCE, ENTER, STACKED, THREAD)
