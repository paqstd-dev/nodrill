...
| the same read through `use()`                          |   61 | 2.6 |
| the same read through `@inject`                        |   73 | 3.1 |
...
| `with provider(...)`, enter and exit                   |  549 |  24 |
| the same with 8 providers already open                 |  629 |  27 |
| `with provider(lazy(...))`, entered and exited unread  | 1478 |  64 |
